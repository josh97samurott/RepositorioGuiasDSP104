...
function App() {
  const baseUrl="http://localhost/dps104_guias_desafios/RepositorioGuiasDSP104/guia08/apiPhpProductos/";
  ...
  const peticionPut=async()=>{
    ...
    f.append("existencias", productoSeleccionado.existencias);
    f.append("METHOD", "PUT");
    await axios.post(baseUrl, f, {params: {id: productoSeleccionado.id}}).then(response=>{
      var dataNueva= data;
