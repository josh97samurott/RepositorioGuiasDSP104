...
function App() {
  const baseUrl="http://localhost/dps104_guias_desafios/RepositorioGuiasDSP104/guia08/apiPhpEscuela/";
  ...
  const peticionPut=async()=>{
    ...
    f.append("edad", alumnoSeleccionado.edad);
    f.append("METHOD", "PUT");
    await axios.post(baseUrl, f, {params: {id: alumnoSeleccionado.id}}).then(response=>{
      var dataNueva= data;
